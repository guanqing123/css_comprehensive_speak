...
- 为什么 a > div 是合法的?
#### 嵌套规则 ####
- html4 http://jkorpela.fi/html/nesting.html
- 根据元素的分类 以及 Content Mode(内容模型)
...
- CSS Reset
	...
	- https://yuilibrary.com/yui/docs/cssreset/	雅虎
...
#### HTML面试真题 ####
- 1.doctype的意义是什么
	- 让浏览器以标准模式渲染(例如：width:200px;ie指的是包含padding是200px,如果设置doc...就不包含padding)
	- 让浏览器知道元素的合法性
